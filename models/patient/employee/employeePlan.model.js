...
EmployeePlanSchema.virtual("remainingDays").get(function () {
  return Math.ceil((this.endDate - new Date()) / (1000 * 60 * 60 * 24));
});
// Virtual property to get usage percentage
EmployeePlanSchema.virtual("usagePercentage").get(function () {
...
module.exports = mongoose.model("EmployeePlan", EmployeePlanSchema);
