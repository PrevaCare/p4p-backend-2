...
const { getDashboardData, getRecentAddedUsers, getTeleconsultationData, getInPersonConsultationData, getCorporateSalesData, getIndividualSalesData } = require("../../controllers/superAdmin/dashboard");
