...
const getFormattedGeneralPhysicalExamination = (latestEmr) => ({
  ...
  lymphadenopathy: latestEmr?.generalPhysicalExamination?.edema || "absent", // Possible swap?
  edema: latestEmr?.generalPhysicalExamination?.lymphadenopathy || "absent", // Possible swap?
...
const getFormattedSystemicExamination = (latestEmr) => ({
  ...
  CVS: latestEmr?.systemicExamination?.CVS || "S1 S2 PRESENT, NO ADDED SOUNDS",
  CNS: latestEmr?.systemicExamination?.CNS || "NO FOCAL NEUROLOGICAL DEFICIT",
  PA: latestEmr?.systemicExamination?.PA || "SOFT, NORMAL BOWEL SOUNDS PRESENT",
